...
/* Fired: (1) after registration; (2)) after an email profile change; or (3) if the user requests another email after (1) or (2). */
...
/* Password Expired */
/* Shows up when: (1) User forgets his password and clicks on the link provided on the email; (2) User forgets his password; remembers it later; and then performs login. */
