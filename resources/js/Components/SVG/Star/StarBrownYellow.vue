...
const starDivBrownYellow = ref(null)
...
onMounted(() => {
    ...
    arrTimeout.push(setTimeout(() => {
        ...
        starDivBrownYellow.value.style.left = x.toString() + 'px'
        starDivBrownYellow.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
...
<template>
    <div class="absolute" ref="starDivBrownYellow">
        <svg v-if="shouldDisplay === 1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" 
            class="w-5 h-5 opacity-80 fill-yellow-900 stroke-yellow-300">
