...
const starDivRedOrange = ref(null)
...
onMounted(() => {
    ...
    arrTimeout.push(setTimeout(() => {
        ...
        starDivRedOrange.value.style.left = x.toString() + 'px'
        starDivRedOrange.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
        x += getRandomIntInclusive(-2,0)
