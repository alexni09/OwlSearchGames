...
onMounted(() => {
    ...
    arrTimeout.push(setTimeout(() => {
        ...
        starDivSkyBlue.value.style.left = x.toString() + 'px'
        starDivSkyBlue.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
