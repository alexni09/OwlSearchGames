...
const starDivPinkFuchsia = ref(null)
...
onMounted(() => {
    ...
    arrTimeout.push(setTimeout(() => {
        ...
        starDivPinkFuchsia.value.style.left = x.toString() + 'px'
        starDivPinkFuchsia.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
        x += getRandomIntInclusive(1,3)
        y += getRandomIntInclusive(1,3)
        starDivPinkFuchsia.value.style.left = x.toString() + 'px'
        starDivPinkFuchsia.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
...
<template>
    <div class="absolute" ref="starDivPinkFuchsia">
        <svg v-if="shouldDisplay === 1" xmlns="http://www.w3.orgaccumulate(100)0/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" 
            class="w-5 h-5 opacity-80 fill-pink-200 stroke-fuchsia-900">
