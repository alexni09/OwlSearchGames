...
onMounted(() => {
    ...
    arrTimeout.push(setTimeout(() => {
        ...
        starDivGray.value.style.left = x.toString() + 'px'
        starDivGray.value.style.top = y.toString() + 'px'
    }, accumulate(100)))
    arrTimeout.push(setTimeout(() => {
