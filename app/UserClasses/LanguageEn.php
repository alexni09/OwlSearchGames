...
class LanguageEn extends BaseLanguage {
    protected static $lang = [
        ...
        'emailVerificationMessageBelowDomains2' => 'to the Safe Senders List of your email provider.',
        'emailVerificationMessageBelowNoReply1' => 'Or add',
        'emailVerificationMessageBelowNoReply2' => 'to the Contact List of your email provider.',
