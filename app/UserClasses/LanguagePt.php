...
class LanguagePt extends BaseLanguage {
    protected static $lang = [
        ...
        'captcha' => 'Por favor complete o seguinte captcha:',
        'captchaPlaceholder' => 'captcha',
        'captchaValidation' => 'Captcha não confere. (Por favor recarregue-o se necessário.)',
        'category' => 'Categoria',
        ...
        'emailVerificationSmallMessage' => 'Um novo link de verificação foi enviado ao endereço de email informado durante o registo.',
        'emailVerificationSubject' => 'Verifique o Endereço de Email',
        'error' => 'ERRO',
        'execute' => 'executar',
        'faq1' => 'FAQ',
        'faq2' => 'Perguntas Frequentes',
        'faqAds1' => 'P. Há anúncios neste sítio?',
        'faqAds2' => 'R. Sem anúncios.',
        ...
        'faqDeveloper1' => 'P. Quais tecnologias são utilizadas neste app?',
        'faqDeveloper2' => 'R. Laravel 10, Inertia, Vite, Vue 3.2, MySQL, Tailwind, PHP, Javascript, HTML, CSS, SVGs, imagens e sons.',
        'faqPoints1' => 'P. Quantos pontos são necessários para alcançar os níveis Avançado e Premium?',
        'faqPoints2' => 'R. 2000 e 10000 pontos respectivamente.',
        'faqPremium1' => 'P. O que está incluso no nível premium?',
        'faqPremium2' => 'R. Muitas outras imgens de fundo exclusivas e a habilidade de gerar jogos insanamente difíceis.',
        'faqPremium3' => 'Ainda, se o usuário alcançar Premium antes de uma determinada data, todos os controles do jogo estarão disponíveis.',
        'faqPremium4' => 'Esses controles incluem: largura, altura, quantidade e dificuldade das palavras; bem como um componente que prevê quão difícil será o jogo. ',
        'faqPremium5' => 'Esta oferta é por tempo limitado!',
        'faqRegister1' => 'P. Quais são os benefícios de se tornar um usuário registado?',
        'faqRegister2' => 'R. Acumular pontos e ganhar prêmios!',
        'faqRegister3' => 'Ainda mais, algumas animações são exibidas apenas para usuários registados.',
        'faqRegister4' => 'Registe-se Agora!',
        ...
        'login2' => 'Entrar',
        'login3' => 'Fazer Login',
        'loginFailed' => 'As credenciais apresentadas não conferem com nossos registos.',
        ...
        'noRecords' => 'Nenhum registo encontrado com os critério(s) especificado(s).',
        ...
        'redefinePasswordText' => 'Enviamos um email para o endereço de email registado conosco, contendo instruções para atribuir sua nova palavra-passe.',
        'register' => 'Registar',
