...
return new class extends Migration {
    ...
    public function up(): void {
        ...
        DB::unprepared("create trigger length_insert_trigger_" . User::MAIN_FIELD . "_users before insert on users
        for each row
        begin
    ...
    public function down(): void {
        DB::unprepared("drop trigger length_insert_trigger_" . User::MAIN_FIELD . "_users;");
    }
};